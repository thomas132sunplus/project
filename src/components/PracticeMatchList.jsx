...
export function PracticeMatchList() {
  ...
  const tournamentMatches = (currentTournamentData?.matches || []).filter(
    (m) => m.tournamentData && m.tournamentData.name,
  );
  return (
    <div className="container mx-auto px-4 py-8">
      <button
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">
          {currentTournamentData.tournament.name}
        </h1>
                      ...
                      {(() => {
                        const start =
                          ...
                          (match.matchInfo.time
                            ? ` ${match.matchInfo.time}`
                            : "");
                        const end = match.matchInfo.endTime
                          ? ` ~ ${match.matchInfo.endTime}`
                          : "";
                        return start + end;
                      })()}
                    </p>
